...
-- https://softuni.bg/downloads/svn/java-databases/Sept-2017/Database-Basics-MySQL/04.%20Built-in-Functions/Lab-Tests-DB-Author-Solutions/booklibrary.sql
-- -----------------------------------------------------------------------------------------------
...
UPDATE 
	`books` 
SET 
    `title` = CONCAT('***', SUBSTRING(`title`, 4))
WHERE
...
-- -----------------------------------------------------------------------------------------------
SELECT 
--    CONCAT(`first_name`, ' ', IF(`middle_name` IS NOT NULL, CONCAT(`middle_name`, ' '), ' '), `last_name`) AS 'Full Name',
